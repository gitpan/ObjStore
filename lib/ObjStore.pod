...
supported except fetch and store.  At least the following works:
...
the indexed records will stay in the right order.
...
Memory is faster than databases.  If you don't need all the guarentees
of data integrity, then pure RAM is as fast as it gets.
