...
much less duplication when moved to C<ObjectStore>.  (Definitely true
if you write C++ extensions.)  Of course, the real test must always be
to code up your problem and make experimental measurements.
...
directory, and C<The SQL Reference Manual> (I<just kidding>)
