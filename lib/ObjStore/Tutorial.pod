...
Once you have won a few times, make sure to read the source code to
see how easy it is to put stuff like this together.

[Caveat: I haven't had time to update the tutorial for quite a few
releases.  Sorry!]
