...
thinking about data the first thing to consider is how to organize to
improve one's ability to evolve.
...
problem can easily be minimized.
...
different from traditional tables I am confident that with a few doses
of Prozac, relational developers should feel right at home.  See
