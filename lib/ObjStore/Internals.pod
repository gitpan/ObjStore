...
equally obvious: the pure, non-mechanical creative principle in
themselves.

Ask yourself these questions: Who is the software designer?  Who
imagines?  Who moves the fingers to type?  IMHO, to try to know
yourself consciously is the most worthy and worthwhile goal.
Therefore, evolution is served by making available software that is
very similar to our mechanical thinking processes.  By understanding
this type of software, consciousness is aided in understanding how the
brain works.  (I am not referring exclusively to the field of
artificial intelligence.  The brain is a data processor in the
broadest sense and the algorithms of artificial intelligence are only
a part of that.)
...
the perspectives that I have consciously distilled.  If you wish to
pursue this to a greater depth, please consider visiting
http://www.purposeofcompetition.org .
